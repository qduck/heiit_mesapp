...
BackgroundJob.register({
    ...
    job: () => {
        ...
        LogInfo('Background Job fired!. regularJobKey =' + regularJobKey);
        BackgroundJob.cancel({ jobKey: regularJobKey });
        LogInfo('Background Job Closed!. regularJobKey =' + regularJobKey);
    }
});
BackgroundJob.register({
    jobKey: exactJobKey,
    job: () => {
        ...
        LogInfo('Exact Job fired!. exactJobKey =' + exactJobKey);
    }
});
BackgroundJob.register({
    ...
    job: () => {
        ...
        LogInfo('Exact Job fired!. foregroundJobKey =' + foregroundJobKey);
    }
});
BackgroundJob.register({
    ...
    job: () => {
        ...
        LogInfo('Ever Running Job fired! everRunningJobKey =' + everRunningJobKey);
    }
});
    ...
    render() {
        return (
          ...
          {this.state.jobs.map(({ jobKey }) => jobKey)}
                ...
                >
                    <Text>Schedule regular job安排日常工作</Text>
                </TouchableHighlight>
                <TouchableHighlight
                    style={styles.button}
                    onPress={() => {
                ...
                >
                    <Text>Schedule exact job安排精确的作业</Text>
                </TouchableHighlight>
                <TouchableHighlight
                    style={styles.button}
                    onPress={() => {
                ...
                >
                    <Text>Schedule exact foreground job计划精确的前台作业</Text>
                </TouchableHighlight>
                <TouchableHighlight
                    style={styles.button}
                    onPress={() => {
                ...
                >
                    <Text>Schedule ever running job调度运行中的作业</Text>
                </TouchableHighlight>
                <TouchableHighlight
                    style={styles.button}
                    onPress={() => {
                ...
                >
                    <Text>Cancel regular job 取消常规作业</Text>
                </TouchableHighlight>
                <TouchableHighlight
                    style={styles.button}
                    onPress={() => {
